 ...
 * <code>android:name</code> or {@link  SaveFragmentNavigator.Destination#setClassName(String)}.
 * <p>
 * The current Fragment from  SaveFragmentNavigator's perspective can be retrieved by calling
 * {@link FragmentManager#getPrimaryNavigationFragment()} with the FragmentManager
 * passed to this  SaveFragmentNavigator.
 * <p>
...
public class SaveFragmentNavigator extends Navigator<SaveFragmentNavigator.Destination> {
    private static final String TAG = " SaveFragmentNavigator";
    ...
    public SaveFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                                 int containerId) {
        mContext = context;
    ...
    @NonNull
    @Override
    public SaveFragmentNavigator.Destination createDestination() {
        return new SaveFragmentNavigator.Destination(this);
    }
    ...
    @Nullable
    @Override
    public NavDestination navigate(@NonNull SaveFragmentNavigator.Destination destination, @Nullable Bundle args,
        ...
        if (navigatorExtras instanceof SaveFragmentNavigator.Extras) {
            SaveFragmentNavigator.Extras extras = (SaveFragmentNavigator.Extras) navigatorExtras;
    ...
    /**
     * NavDestination specific to {@link  SaveFragmentNavigator}
     */
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(SaveFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param SaveFragmentNavigator The {@link  SaveFragmentNavigator} which this destination
         *                              will be associated with. Generally retrieved via a
         *                              {@link NavController}'s
         *                              {@link NavigatorProvider#getNavigator(Class)} method.
         */
        public Destination(@NonNull Navigator<? extends SaveFragmentNavigator.Destination> SaveFragmentNavigator) {
            super(SaveFragmentNavigator);
        }
        ...
        public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs) {
            ...
            TypedArray a = context.getResources().obtainAttributes(attrs,
                    R.styleable.SaveFragmentNavigator);
         ...
         *                  destination
         * @return this {@link  SaveFragmentNavigator.Destination}
         */
        @NonNull
        public final SaveFragmentNavigator.Destination setClassName(@NonNull String className) {
    ...
    /**
     * Extras that can be passed to  SaveFragmentNavigator to enable Fragment specific behavior
     */
    public static final class Extras implements Navigator.Extras {
        ...
        /**
         * Builder for constructing new {@link  SaveFragmentNavigator.Extras} instances. The resulting instances are
         * immutable.
         */
        public static final class Builder {
             ...
             * @return this {@link  SaveFragmentNavigator.Extras.Builder}
             */
            @NonNull
            public SaveFragmentNavigator.Extras.Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
             ...
             */
            @NonNull
            public SaveFragmentNavigator.Extras.Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
                mSharedElements.put(sharedElement, name);
                return this;
            }

            /**
             * Constructs the final {@link  SaveFragmentNavigator.Extras} instance.
             *
             * @return An immutable {@link  SaveFragmentNavigator.Extras} instance.
             */
            @NonNull
            public SaveFragmentNavigator.Extras build() {
                return new SaveFragmentNavigator.Extras(mSharedElements);
            }
        }
    }
}
