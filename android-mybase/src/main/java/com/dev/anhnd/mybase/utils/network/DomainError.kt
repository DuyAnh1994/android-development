...
//            get() = when (error) {
//                is BaseError -> {
//                    val id = error.error?.id ?: ""
//                    var errorMessageWithId = Constants.getErrorApiContent(id)
//                    if (errorMessageWithId.isNullOrEmpty()) {
//                        errorMessageWithId = error.error?.message ?: ""
//                    }
//                    errorMessageWithId
//                }
//                else -> ""
...
//                else -> com.dev.anhnd.mybase.utils.network.error("unexpected: $throwable")
//            }
//
//        override val errorMessage
...
//    var details: List<ErrorDetail>? = null
//)
//
